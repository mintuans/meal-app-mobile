...
import { Search, UserPlus, Trash2, Shield, User, Power, LogOut, ChevronRight, X, Calendar, Activity, Mail, Scale, Ruler, Wallet, Bell } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50 dark:bg-slate-950">
      ...
      <div className="px-6 mb-8">
        <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] px-1 mb-4 text-center">Tiện ích quản trị</h3>
        <div className="grid grid-cols-2 gap-4">
          <Card 
            onClick={() => navigate('/notifications/manage')}
            className="p-5 bg-white dark:bg-slate-900 border-none shadow-sm hover:scale-[1.02] active:scale-95 transition-all cursor-pointer flex flex-col items-center gap-3 group"
          >
            <div className="size-12 rounded-2xl bg-blue-100 dark:bg-blue-500/10 text-blue-600 flex items-center justify-center group-hover:bg-blue-500 group-hover:text-white transition-all">
              <Bell size={24} />
            </div>
            <span className="text-[10px] font-black text-slate-700 dark:text-slate-200 uppercase tracking-widest text-center">Quản lý thông báo</span>
          </Card>
        </div>
      </div>
