...
import { NotificationManagement } from '@/src/screens/Notifications/NotificationManagement';
import { UserNotifications } from '@/src/screens/Notifications/UserNotifications';
...
export const AppNavigator = () => {
  return (
    <Routes>
      ...
      <Route path="/notifications/manage" element={<ProtectedRoute requireAdmin><NotificationManagement /></ProtectedRoute>} />
